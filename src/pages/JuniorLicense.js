...
function JuniorLicense() {
  ...
  async function getPageData() {
    const data = await fetch(
      "https://cms-james-medows.herokuapp.com/api/junior-license-page?populate=deep"
    );
