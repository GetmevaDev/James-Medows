...
function ViolatingCourtJudgment() {
  ...
  async function getPageData() {
    const data = await fetch(
      "https://cms-james-medows.herokuapp.com/api/violating-a-court-page?populate=deep"
    );
  ...
  return (
    <main className='violatingCourtJudgment'>
      <GeneralHero
        title={banner.title}
...
export default ViolatingCourtJudgment
