...
function RecklessDrivingLawyer() {
  ...
  async function getPageData() {
    const data = await fetch(
      "https://cms-james-medows.herokuapp.com/api/reckless-driving-page?populate=deep"
    );
  ...
  return (
    <main className='RecklessDrivingLawyer'>
      <SEO
        title={seo?.title}
...
export default RecklessDrivingLawyer
