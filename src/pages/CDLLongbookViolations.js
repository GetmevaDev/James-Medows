...
function CDLLongbookViolations() {
  ...
  async function getPageData() {
    const data = await fetch(
      "https://cms-james-medows.herokuapp.com/api/cdl-logbook-violations-page?populate=deep"
    );
  ...
  return (
    <main className='CDLLongbookViolations'>
     <SEO
        title={seo?.title}
...
export default CDLLongbookViolations
