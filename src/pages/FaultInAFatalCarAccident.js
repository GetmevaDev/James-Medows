...
function FaultInAFatalCarAccident() {
  ...
  async function getPageData() {
    const data = await fetch(
      "https://cms-james-medows.herokuapp.com/api/fault-in-a-fatal-car-page?populate=deep"
    );
  ...
  return (
    <main className='faultAFatalCarAccident'>
      <SEO
        title={seo?.title}
...
export default FaultInAFatalCarAccident
